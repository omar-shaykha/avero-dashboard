...
export default function CashierSettingsContent(){
  ...
  return <div className="space-y-6">
      <div><h2 className="text-2xl font-black">{L("Cashier Setup","إعداد الكاشير")}</h2><p className="mt-2 text-sm text-slate-400">{L("Payment methods, cashier categories, items and Best Sellers.","طرق الدفع وتصنيفات الكاشير والأصناف والأكثر مبيعاً.")}</p></div>
