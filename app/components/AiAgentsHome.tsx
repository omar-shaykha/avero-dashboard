...
const agents = [
  { name: "Leo", animal: "🦁", title: "Sales Agent", line: "The Opportunity Hunter", href: "/ai-sales", color: "text-amber-300", skills: ["Qualifies leads", "Follows up automatically", "Turns inquiries into customers", "Schedules meetings"], quote: "More customers. Bigger opportunities.", icon: Bot },
  { name: "Gor", animal: "🦍", title: "Support Agent", line: "The Problem Solver", href: "/ai-support", color: "text-emerald-300", skills: ["Handles questions", "Solves issues fast", "Provides product support", "Keeps customers happy"], quote: "Happier customers. Stronger loyalty.", icon: Headphones },
  { name: "Aero", animal: "🦅", title: "HR & Booking Agent", line: "The Planner", href: "/ai-hr", color: "text-sky-300", skills: ["HR tasks", "Bookings", "Confirmations", "Reminders"], quote: "A fuller calendar. A smoother business.", icon: CalendarClock },
  { name: "Foxy", animal: "🦊", title: "Marketing Agent", line: "The Growth Creator", href: "/ai-marketing", color: "text-orange-300", skills: ["Creates content", "Runs campaigns", "Manages social media", "Suggests new ideas"], quote: "More reach. Stronger brand.", icon: Sparkles },
  { name: "Vexa", animal: "🐍", title: "Inventory Agent", line: "The Watcher", href: "/ai-inventory", color: "text-rose-300", skills: ["Tracks stock", "Alerts low stock", "Suggests purchases", "Prevents stockouts"], quote: "The right stock. At the right time.", icon: PackageCheck },
  { name: "Rex", animal: "🐕", title: "Customer Care Agent", line: "The Loyal Companion", href: "/ai-customer-care", color: "text-purple-300", skills: ["Welcomes customers", "Collects feedback", "Builds loyalty", "Handles complaints"], quote: "Customers for today. Loyalty for tomorrow.", icon: UsersRound },
  { name: "Nova", animal: "🐈", title: "Analytics Agent", line: "The Insight Maker", href: "/ai-analytics", color: "text-cyan-300", skills: ["Analyzes trends", "Creates reports", "Finds opportunities", "Gives recommendations"], quote: "Clear insights. Smarter decisions.", icon: BarChart3 },
...
function Mini({ label }: { label: string }) { return <div className="rounded-2xl border border-cyan-400/20 bg-cyan-400/10 px-4 py-3 text-sm font-semibold text-cyan-100">{label}</div>; }
