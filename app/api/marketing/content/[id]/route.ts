...
function makeSvg(input: { brand: string }) {
  return `<svg width="1080" height="1080" viewBox="0 0 1080 1080" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="g" cx="25%" cy="15%" r="80%"><stop offset="0" stop-color="#123A55"/><stop offset=".48" stop-color="#061427"/><stop offset="1" stop-color="#020617"/></radialGradient><linearGradient id="c" x1="0" x2="1"><stop stop-color="#22D3EE"/><stop offset="1" stop-color="#14B8A6"/></linearGradient></defs><rect width="1080" height="1080" fill="url(#g)"/><circle cx="840" cy="170" r="230" fill="#22D3EE" opacity=".12"/><circle cx="150" cy="895" r="260" fill="#14B8A6" opacity=".11"/><rect x="80" y="80" width="920" height="920" rx="58" fill="none" stroke="#22D3EE" stroke-opacity=".32" stroke-width="2"/><path d="M140 308 C285 190 385 420 548 315 C700 220 785 318 940 250" fill="none" stroke="#22D3EE" stroke-width="3" opacity=".55"/><text x="125" y="150" fill="#67E8F9" font-size="22" font-family="Arial, sans-serif" font-weight="900" letter-spacing="6">${esc(input.brand)}</text><text x="125" y="420" fill="#F8FAFC" font-size="92" font-family="Arial, sans-serif" font-weight="900">AVERO OS</text><text x="125" y="505" fill="#CBD5E1" font-size="36" font-family="Arial, sans-serif" font-weight="700">Business Operations Platform</text><rect x="125" y="650" width="830" height="145" rx="34" fill="#031525" stroke="#22D3EE" stroke-opacity=".36"/><text x="170" y="713" fill="#E0F2FE" font-size="28" font-family="Arial, sans-serif" font-weight="900">SALES · CRM · POS · INVENTORY</text><text x="170" y="756" fill="#67E8F9" font-size="22" font-family="Arial, sans-serif" font-weight="800">AI AGENTS · OPERATIONS · AUTOMATION</text><text x="125" y="930" fill="#22D3EE" font-size="24" font-family="Arial, sans-serif" font-weight="900" letter-spacing="5">RUN YOUR BUSINESS FROM ONE SYSTEM</text></svg>`;
}
...
async function ensureMediaUrl(s: SupabaseClient, item: Record<string, any>, companyId: string) {
  ...
  const image = await sharp(Buffer.from(makeSvg({ brand: brandKit?.brand_name || "AVERO OS" }))).jpeg({ quality: 88, mozjpeg: true }).toBuffer();
